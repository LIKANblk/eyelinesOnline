randov_vs_normal_clf_compare_tables <- function(exp_nums){
  ...
  write.table(df_random_ball, '/home/mayenok/Yandex.Disk/eyelinesOnlineNew/tables/df_random_ball.csv', quote = F, row.names = F, sep = ' ')
  write.table(df_test_ball, '/home/mayenok/Yandex.Disk/eyelinesOnlineNew/tables/df_test_ball.csv', quote = F, row.names = F, sep = ' ')
  write.table(df_random_field, '/home/mayenok/Yandex.Disk/eyelinesOnlineNew/tables/df_random_field.csv', quote = F, row.names = F, sep = ' ')
  write.table(df_test_field, '/home/mayenok/Yandex.Disk/eyelinesOnlineNew/tables/df_test_field.csv', quote = F, row.names = F, sep = ' ')
